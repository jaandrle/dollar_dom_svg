...
const $dom_svg= (function(){
    ...
    _public.chart_parts.addAxeLine= function({ width, height }){
    ...
    _public.chart_parts.addLabelsTicksForAxeX= function({
    ...
    _public.chart_parts.addLabelsTicksForAxeY= function({
    ...
    _public.chart_helpers.dataToPolylinePoints= function({ dataX, dataY, metric: [ dX, dY, minimum ] }){
    ...
    _public.chart_helpers.getAxeYParams= function(axis, chart, metric, params= {}){
